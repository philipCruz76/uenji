...
const SmallScreenJoinSheet = () => {
  let { isOpen, setIsOpen } = useOpenModalStore();
  let { setMobileNav } = useOpenMobileNavStore();
    ...
    <>
      <Drawer.Root open={isOpen}>
        <Drawer.Portal>
          ...
          <Drawer.Content className=" flex flex-col z-40 bg-white pt-6 h-full rounded-t-[10px] mt-24 fixed  bottom-0 left-0 right-0">
            <div className="flex relative items-start mx-auto px-4 py-4  font-bold text-3xl">
              {signInText.title}
            </div>
            <Drawer.Close className="absolute top-6 right-6">
              <button
            ...
            <div className="container flex flex-col space-y-3 items-center justify-center mx-auto my-auto  sm:px-3">
              ...
              <div className="flex flex-col py-10 space-y-2 items-start font-semibold text-sm">
                ...
                <button className="flex flex-row mx-auto border w-[350px] h-[50px] items-center space-x-4">
                  ...
                  <p className=" flex items-center text-center justify-center mx-auto flex-1 pr-10 ">
                    {" "}
                ...
                <button className="flex flex-row mx-auto border w-[350px] h-[50px] items-center space-x-4">
                  ...
                  <p className="flex items-center text-center justify-center mx-auto flex-1">
                    Continue with Apple
                  </p>
                </button>
