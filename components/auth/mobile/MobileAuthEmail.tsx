...
const MobileAuthEmail = () => {
  ...
  return (
    <section className="flex flex-col min-w-screen">
      {/* Auth form */}
      <div className="container w-full flex flex-col space-y-3 text-left mt-12">
...
export default MobileAuthEmail;
