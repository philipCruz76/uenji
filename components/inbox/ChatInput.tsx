    ...
    <div className="flex flex-row border-t border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
      <div className="relative flex flex-1 overflow-hidden rounded-lg ">
        ...
        <button className=" flex flex-row relative">
          <div className="flex flex-wrap flex-row  items-center text-center justify-center text-xs cursor-text text-gray-500">
          <span >Files up to 512 MB,</span>
          ...
          onClientUploadComplete={(res)=> {
            ...
            res?.map((file)=> toast.success(file.url))
          }}
