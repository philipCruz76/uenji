  ...
  return (
    ...
    <Transition appear show={opened} as={Fragment}>
      ...
      <Dialog as="div" className='container flex flex-col fixed top-0 left-0 right-0 bottom-0 z-20 border text-black border-white bg-white rounded-md overflow-y-scroll' onClose={() => setOpenState(false)}>
        ...
        {/* Modal Content */}
        <div className="flex flex-col space-y-3 text-left my-auto px-3">
          ...
          <div className="flex flex-col py-10 space-y-2 items-start font-semibold text-sm">
            ...
            {/*Divider*/}
            <div className="flex w-full py-4 items-center justify-center text-center font-light text-black">
              <div className="w-full h-px bg-gray-300 " />
              <p className="px-4">OR</p>
              <div className="w-full h-px bg-gray-300 " />
            </div>

            {/* TODO Credentials input*/}
