...
const OrderCreatedEvent = ({
  ...
  return (
    <div className="w-full h-fit">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-2 text-xl border-b">
        <svg
...
C23.3,16.1,23.2,17.6,22.9,19.1z"
        ...
        <div className="flex flex-row gap-2 items-center justify-center py-4">
          <span className="font-semibold">{orderEvent.user}</span>

          <span className="font-semibold text-sky-500">{text}</span>
        </div>
      </div>
    </div>
  );
