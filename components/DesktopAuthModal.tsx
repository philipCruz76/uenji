...
const DesktopAuthModal: FC<DesktopAuthModalProps> = ({ opened, signedIn, setOpenState }) => {
  ...
  return (
    <Transition appear show={opened} as={Fragment}>
      <Dialog as="div" className="fixed flex inset-0 z-10 overflow-y-auto" onClose={() => setOpenState(false)}>
        <Transition.Child
          as={Fragment}
