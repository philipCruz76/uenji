        ...
        <>
            ...
            < div className="container flex absolute z-1 inset-0 mt-56 px-6 flex-col items-start justify-start " >
                ...
                <div className="flex py-6">
                    <input type="text" placeholder="Pesquise pelo serviço " className="border-2 border-slate-300 bg-white h-12 px-5 desktop:w-[600px] rounded-l-md text-sm text-black focus:outline-none focus:border-slate-500" />
                    <button type="submit" className="flex  border-black bg-black rounded-r-md w-[50px] items-center justify-between text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-16 0 50 24" strokeWidth="1.5" stroke="white" className="flex items-center justify-between w-10 h-12">
