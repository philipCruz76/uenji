    ...
    <div className="bg-zinc-900 w-full h-[420px] px-4 flex flex-col items-center justify-center">
      ...
      <div className="py-6 max-w-[440px] w-full">
        <div className="flex desktop:gap-4 tablet:gap-2 gap-[4px]">
          <div className="tablet:text-4xl text-3xl font-bold text-white ">
            Find the right
          </div>
          <div className="tablet:text-4xl  text-3xl font-serif italic text-white">
            freelance
          </div>
        </div>
      ...
      <button className="bg-sky-500 w-full h-[50px] items-center justify-between text-center text-white px-4 py-2 rounded-md border-none max-w-[440px]">
        <svg
          ...
          strokeWidth="1.5"
          stroke="white"
          className="w-5 h-5 items-center justify-between text-center"
        >
          <path
            strokeLinecap="round"
