...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'account' | 'session' | 'user' | 'activateToken' | 'gig' | 'order' | 'review' | 'conversation' | 'message'
    ...
    model: {
      ...
      ActivateToken: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.ActivateTokenFindRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          aggregateRaw: {
            args: Prisma.ActivateTokenAggregateRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          count: {
   ...
   */
  export type GigCountOutputTypeDefaultArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
  ...
  export interface Prisma__UserClient<T, Null = never, ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    ...
    Gig<T extends User$GigArgs<ExtArgs> = {}>(args?: Subset<T, User$GigArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$GigPayload<ExtArgs>, T, 'findMany'> | Null>;
  ...
  interface UserFieldRefs {
    ...
    readonly achievement: FieldRef<"User", 'String'>
    readonly emailVerified: FieldRef<"User", 'DateTime'>
    readonly business: FieldRef<"User", 'String'>
  ...
  export interface ActivateTokenDelegate<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> {
    ...
    **/
    ...
    /**
     * Find zero or more ActivateTokens that matches the filter.
     * @param {ActivateTokenFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const activateToken = await prisma.activateToken.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
      args?: ActivateTokenFindRawArgs
    ): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a ActivateToken.
     * @param {ActivateTokenAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const activateToken = await prisma.activateToken.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
    ...
    **/
    aggregateRaw(
      args?: ActivateTokenAggregateRawArgs
    ): Prisma.PrismaPromise<JsonObject>
  ...
  interface ActivateTokenFieldRefs {
    ...
    readonly activationLink: FieldRef<"ActivateToken", 'String'>
    readonly userEmail: FieldRef<"ActivateToken", 'String'>
  ...
  /**
   * ActivateToken findRaw
   */
  export type ActivateTokenFindRawArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * ActivateToken aggregateRaw
   */
  export type ActivateTokenAggregateRawArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export interface GigDelegate<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> {
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export interface Prisma__GigClient<T, Null = never, ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';

    user<T extends UserDefaultArgs<ExtArgs> = {}>(args?: Subset<T, UserDefaultArgs<ExtArgs>>): Prisma__UserClient<$Result.GetResult<Prisma.$UserPayload<ExtArgs>, T, 'findUniqueOrThrow'> | Null, Null, ExtArgs>;

    Order<T extends Gig$OrderArgs<ExtArgs> = {}>(args?: Subset<T, Gig$OrderArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$OrderPayload<ExtArgs>, T, 'findMany'> | Null>;

    Review<T extends Gig$ReviewArgs<ExtArgs> = {}>(args?: Subset<T, Gig$ReviewArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ReviewPayload<ExtArgs>, T, 'findMany'> | Null>;
  ...
  interface GigFieldRefs {
    ...
    readonly totalRatings: FieldRef<"Gig", 'Int'>
    readonly ratingNumber: FieldRef<"Gig", 'Int'>
    readonly category: FieldRef<"Gig", 'String'>
    readonly price: FieldRef<"Gig", 'Float'>
    readonly coverImage: FieldRef<"Gig", 'String'>
    readonly images: FieldRef<"Gig", 'String[]'>
    readonly shortTitle: FieldRef<"Gig", 'String'>
    readonly deliveryTime: FieldRef<"Gig", 'Int'>
    readonly revisionNumber: FieldRef<"Gig", 'Int'>
    readonly features: FieldRef<"Gig", 'String[]'>
    readonly sales: FieldRef<"Gig", 'Int'>
   ...
   * Gig findUnique
   */
  export type GigFindUniqueArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Gig
     */
    select?: GigSelect<ExtArgs> | null
   ...
   * Gig findFirst
   */
  export type GigFindFirstArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Gig
     */
    select?: GigSelect<ExtArgs> | null
   ...
   * Gig without action
   */
  export type GigDefaultArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Gig
     */
    select?: GigSelect<ExtArgs> | null
   ...
   * Order.review
   */
  export type Order$reviewArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Review
     */
    select?: ReviewSelect<ExtArgs> | null
  ...
  interface ConversationFieldRefs {
    ...
    readonly readBySeller: FieldRef<"Conversation", 'Boolean'>
    readonly readByBuyer: FieldRef<"Conversation", 'Boolean'>
  ...
  export type UserWhereInput = {
    ...
    achievement?: StringNullableFilter<"User"> | string | null
    emailVerified?: DateTimeNullableFilter<"User"> | Date | string | null
    business?: StringNullableFilter<"User"> | string | null
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    achievement?: StringNullableWithAggregatesFilter<"User"> | string | null
    emailVerified?: DateTimeNullableWithAggregatesFilter<"User"> | Date | string | null
    business?: StringNullableWithAggregatesFilter<"User"> | string | null
  ...
  export type ActivateTokenWhereInput = {
    ...
    activationLink?: StringFilter<"ActivateToken"> | string
    userEmail?: StringFilter<"ActivateToken"> | string
  ...
  export type ActivateTokenScalarWhereWithAggregatesInput = {
    ...
    activationLink?: StringWithAggregatesFilter<"ActivateToken"> | string
    userEmail?: StringWithAggregatesFilter<"ActivateToken"> | string
  ...
  export type GigWhereInput = {
    ...
    totalRatings?: IntNullableFilter<"Gig"> | number | null
    ratingNumber?: IntNullableFilter<"Gig"> | number | null
    category?: StringFilter<"Gig"> | string
    price?: FloatFilter<"Gig"> | number
    coverImage?: StringNullableFilter<"Gig"> | string | null
    images?: StringNullableListFilter<"Gig">
    shortTitle?: StringFilter<"Gig"> | string
    deliveryTime?: IntFilter<"Gig"> | number
    revisionNumber?: IntFilter<"Gig"> | number
    features?: StringNullableListFilter<"Gig">
    sales?: IntNullableFilter<"Gig"> | number | null
  ...
  export type GigScalarWhereWithAggregatesInput = {
    ...
    totalRatings?: IntNullableWithAggregatesFilter<"Gig"> | number | null
    ratingNumber?: IntNullableWithAggregatesFilter<"Gig"> | number | null
    category?: StringWithAggregatesFilter<"Gig"> | string
    price?: FloatWithAggregatesFilter<"Gig"> | number
    coverImage?: StringNullableWithAggregatesFilter<"Gig"> | string | null
    images?: StringNullableListFilter<"Gig">
    shortTitle?: StringWithAggregatesFilter<"Gig"> | string
    deliveryTime?: IntWithAggregatesFilter<"Gig"> | number
    revisionNumber?: IntWithAggregatesFilter<"Gig"> | number
    features?: StringNullableListFilter<"Gig">
    sales?: IntNullableWithAggregatesFilter<"Gig"> | number | null
  ...
  export type OrderWhereInput = {
    ...
    isCompleted?: BoolNullableFilter<"Order"> | boolean | null
    paymentIntent?: StringFilter<"Order"> | string
  ...
  export type OrderScalarWhereWithAggregatesInput = {
    ...
    isCompleted?: BoolNullableWithAggregatesFilter<"Order"> | boolean | null
    paymentIntent?: StringWithAggregatesFilter<"Order"> | string
  ...
  export type ConversationWhereInput = {
    ...
    readBySeller?: BoolFilter<"Conversation"> | boolean
    readByBuyer?: BoolFilter<"Conversation"> | boolean
  ...
  export type ConversationScalarWhereWithAggregatesInput = {
    ...
    readBySeller?: BoolWithAggregatesFilter<"Conversation"> | boolean
    readByBuyer?: BoolWithAggregatesFilter<"Conversation"> | boolean
  ...
  export type GigCreateInput = {
    ...
    deliveryTime: number
    revisionNumber?: number
    features?: GigCreatefeaturesInput | string[]
    sales?: number | null
    createdAt?: Date | string
    updatedAt?: Date | string
  ...
  export type GigUpdateInput = {
    ...
    features?: GigUpdatefeaturesInput | string[]
  ...
  export type UserUpdateOneRequiredWithoutGigNestedInput = {
    ...
    connect?: UserWhereUniqueInput
    update?: XOR<XOR<UserUpdateToOneWithWhereWithoutGigInput, UserUpdateWithoutGigInput>, UserUncheckedUpdateWithoutGigInput>
  }
  ...
  export type GigUpdateOneRequiredWithoutOrderNestedInput = {
    ...
    connect?: GigWhereUniqueInput
    update?: XOR<XOR<GigUpdateToOneWithWhereWithoutOrderInput, GigUpdateWithoutOrderInput>, GigUncheckedUpdateWithoutOrderInput>
  }
  ...
  export type GigUpdateOneRequiredWithoutReviewNestedInput = {
    ...
    connect?: GigWhereUniqueInput
    update?: XOR<XOR<GigUpdateToOneWithWhereWithoutReviewInput, GigUpdateWithoutReviewInput>, GigUncheckedUpdateWithoutReviewInput>
  }
  ...
  export type UserUpdateToOneWithWhereWithoutGigInput = {
    where?: UserWhereInput
    data: XOR<UserUpdateWithoutGigInput, UserUncheckedUpdateWithoutGigInput>
  }
  ...
  export type GigUpdateToOneWithWhereWithoutOrderInput = {
    where?: GigWhereInput
    data: XOR<GigUpdateWithoutOrderInput, GigUncheckedUpdateWithoutOrderInput>
  }
  ...
  export type GigUpdateToOneWithWhereWithoutReviewInput = {
    where?: GigWhereInput
    data: XOR<GigUpdateWithoutReviewInput, GigUncheckedUpdateWithoutReviewInput>
  }
   ...
   */
     ...
     */
    export type GigCountOutputTypeArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = GigCountOutputTypeDefaultArgs<ExtArgs>
    /**
     ...
     */
    export type GigArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = GigDefaultArgs<ExtArgs>
    /**
